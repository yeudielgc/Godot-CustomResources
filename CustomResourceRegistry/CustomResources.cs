...
// Edited by themasky7 to make it feel more 'native'
// wmigor's Public Repo: https://github.com/wmigor/godot-mono-custom-resource-register
// Atlinx's Public Repo: https://github.com/Atlinx/Godot-Mono-CustomResourceRegistry
namespace Godot.CustomResourcesPlugin
{
	#if TOOLS
	[Tool]
	public class CustomResources : EditorPlugin
	{
		...
		public override void _EnterTree()
		{
			...
			refreshButton.Text = "Register";
			refreshButton.HintTooltip = "Refreshes and registers existing custom Resources/Nodes";
		...
		{
			RegisterAttribute attribute = (RegisterAttribute) Attribute.GetCustomAttribute(type, typeof(RegisterAttribute));
		...
		{
			var assembly = Assembly.GetAssembly(typeof(CustomResources));
			return assembly.GetTypes().Where(t => !t.IsAbstract 
				&& Attribute.IsDefined(t, typeof(RegisterAttribute)) 
